    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300">
      <div className="bg-white p-3 sm:p-8 rounded-3xl shadow-[0_8px_40px_rgba(0,98,139,0.28)] border border-blue-dark/50 w-full max-w-xs sm:max-w-md flex flex-col items-center animate-fade-in-up overflow-hidden">
        ...
        <div className="w-full flex flex-col items-center mb-4 animate-fade-in">
          <h2 className="text-lg sm:text-xl font-semibold text-blue-dark mb-1">Recuperar contraseña</h2>
          <p className="text-gray-500 text-sm sm:text-base text-center">Ingresa tu correo para recibir el enlace de recuperación</p>
        </div>
        <form className="flex flex-col gap-4 w-full mt-2" onSubmit={handleSubmit}>
          ...
          >
            ...
            {loading ? (
              <span className="flex items-center gap-2"><span className="loader loader-sm border-white"></span> Enviando...</span>
            ) : 'Enviar enlace'}
          </button>
